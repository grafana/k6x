...
func Build(ctx context.Context, ings resolver.Ingredients, dir string, afs afero.Fs) error {
...
func (b *builder) start(ctx context.Context, ings resolver.Ingredients) (string, error) {
...
func (b *builder) wait(ctx context.Context, id string) error {
...
func (b *builder) log(ctx context.Context, id string) error {
...
func (b *builder) copy(ctx context.Context, id string, dir string, afs afero.Fs) error {
...
func (b *builder) build(
	...
	logrus.Debug("Building new k6 binary...")
